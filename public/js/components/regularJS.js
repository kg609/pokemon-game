  ...
  init: function init() {
    ...
    while (i < gameState.elements.pokemonsEl.length) {
      ...
      gameState.elements.pokemonsEl[i].onclick = function () {
        ...
        gameState.currentPokemon[0].health = gameState.calculateHealth(gameState.currentPokemon);
        gameState.currentPokemon[0].originalHealth = gameState.calculateHealth(gameState.currentPokemon);
    ...
    switch (userAttack) {
      case "rock":
        ...
        if (cpuAttack == "scissors") {
          if (currentPokemon.health >= 1 && currentRivalPokemon.health >= 1) {
            // user
            gameState.attackMove(currentPokemon.attack, currentPokemon.level, 0.8, 0.2, currentRivalPokemon, currentPokemon);
            if (currentRivalPokemon.health >= 1) {
              // cpu/rival
